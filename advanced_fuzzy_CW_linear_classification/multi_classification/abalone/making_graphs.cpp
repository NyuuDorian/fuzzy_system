...
//ifstream fichier("MON_FICHIER.txt");
		ifstream fichier("test_result_abalone_normalized_multiclass.txt");
		if(fichier)
		{
...
//utilisation de la librairie CImg
		CImg<unsigned char> img(TAILLE_IMAGE*9,TAILLE_IMAGE,1,3);        // Define a 100x100 color image with 8 bits per color component.
