...
//TODO LIST few modifications of the functions used below and defined a little in the upper part ==> DONE
				...
				if(n%NBRE_POINTS_TO_USE==NBRE_POINTS_TO_USE-1 || n==(int)mat_of_all_points_rank.size()-1)
				{
...
//calc of vector membership value of vector x
			...
			test_result << (double)counter_correct_classification*100/nbre_elt << "\t" << endl;//" " << minus_pos << " " << maxi_pos << " " << null_pos << endl;
