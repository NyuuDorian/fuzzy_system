...
//lecture fichier ayame10.dat
				...
				//cout << ", ";
				if(found!=string::npos) depart=found+2;
			}
			//cout << "\n";
...
//calc of Gijkl && CFijkl
				...
				if((mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])>0) mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]-max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2],mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]);
				else /*cout << "G1 && none value of CF" << endl;*/mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=0;
				//cout << "G1" << endl;

				//if(mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]<0) cout << mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1] << "\t";
...
//calc of Gijkl && CFijkl
				...
				if((mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])>0) mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]-max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1],mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]);
				else /*cout << "G2 && none value of CF" << endl;*/mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=0;
				//cout << "G2" << endl;

				//if(mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]<0) cout << "G2" << mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1] << "\t";
				//cout << (mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]-(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]/(K-1)+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]/(K-1)))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]) << "\t";

					//if(mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]<0) cout << mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2] << "\t" << mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1] << "\t" << mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3] << endl;
			}
...
//calc of Gijkl && CFijkl
				...
				if((mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])>0) mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]-max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2],mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]);
				else /*cout << "G3 && none value of CF" << endl;*/mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=0;
				//cout << "G3" << endl;

				//if(mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]<0) cout << "G3" << mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1] << "\t";
			}
...
//if Gijkl == NONE
			...
			{
//calc of Gijkl && CFijkl
				/*if(max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1],max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2],mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]))==mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1] && mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]!=0) cout << mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1] << endl;
				if(max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1],max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2],mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]))==mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2] && mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]!=0) cout << "C2\t" << mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2] << endl;
				if(max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1],max(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2],mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]))==mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3] && mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]!=0) cout << "C3\t" << mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1] << endl;*/
				//cout << "need fuzzy rule" << endl;
				mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][0]=0;
				mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=0;
				//cout << i << j << k << l << "\tNEITHER GROUP NOR CF" << endl;
			}

			//if(mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]<0) cout << i << j << k << l << "\t" << mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1] << endl;
		...
		for(int m=0; m<NBRE_PTS; m++)
		{
			...
			double mat_of_all_alpha[NBRE_CLASSE+1]={0};
			i=0; j=0; k=0; l=0;
			while(i!=K)
			{
...
//CALC OF ALPHA1, ALPHA2, ALPHA3 for each point
        	...
        	alpha3=max(get_value_membership_function(mat_initial_coord[m][0], (double)i+1, K)*get_value_membership_function(mat_initial_coord[m][1], (double)j+1, K)*get_value_membership_function(mat_initial_coord[m][2], (double)k+1, K)*get_value_membership_function(mat_initial_coord[m][3], (double)l+1, K)*mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1], alpha3);
				...
				mat_of_all_alpha[(int)mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][0]]=max(get_value_membership_function(mat_initial_coord[m][0], (double)i+1, K)*get_value_membership_function(mat_initial_coord[m][1], (double)j+1, K)*get_value_membership_function(mat_initial_coord[m][2], (double)k+1, K)*get_value_membership_function(mat_initial_coord[m][3], (double)l+1, K)*mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1], mat_of_all_alpha[(int)mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][0]]);
			...
			if(mat_of_all_alpha[1] > mat_of_all_alpha[2] && mat_of_all_alpha[1] > mat_of_all_alpha[3]) mat_final_value_of_each_point[m]=1;
			else if(mat_of_all_alpha[2] > mat_of_all_alpha[1] && mat_of_all_alpha[2] > mat_of_all_alpha[3]) mat_final_value_of_each_point[m]=2;
			else if(mat_of_all_alpha[3] > mat_of_all_alpha[2] && mat_of_all_alpha[3] > mat_of_all_alpha[1]) mat_final_value_of_each_point[m]=3;
			else
			{
				//if(max(alpha1, max(alpha2, alpha3)) == alpha1 && alpha1 != 0) cout << "G1" << alpha1 << endl;
				//if(max(alpha1, max(alpha2, alpha3)) == alpha2 && alpha2 != 0) cout << "G2" << alpha2 << endl;
				//if(max(alpha1, max(alpha2, alpha3)) == alpha3 && alpha3 != 0) cout << "G3" << alpha3 << endl; 
				mat_final_value_of_each_point[m]=0;				
			}
