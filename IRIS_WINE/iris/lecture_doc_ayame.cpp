...
//calc of Gijkl && CFijkl
				...
				if((mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])>0) mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]-(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])/(NBRE_CLASSE-1))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]);
...
//calc of Gijkl && CFijkl
				...
				if((mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])>0) mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]-(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])/(NBRE_CLASSE-1))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]);
...
//calc of Gijkl && CFijkl
				...
				if((mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3])>0) mat_of_all_Gij_CFij[(int)K-2][i][j][k][l][1]=(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]-(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1])/(NBRE_CLASSE-1))/(mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][1]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][2]+mat_of_adaptability_of_all_area[(int)K-2][i][j][k][l][3]);
